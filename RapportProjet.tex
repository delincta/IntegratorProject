...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Mpc_tank_states_hor200_2000iter.png}
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Simulator_tank_states_hor200_2000iter.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Mpc_cells_states_hor200_2000iter.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{Simulator_cells_states_hor200_2000iter.png}
