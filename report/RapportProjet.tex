...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/merge_graph/Graph.png}
    \caption{Network with two Tanks and six Cells}
...
\begin{figure}[H]
    ...
    \caption{Two different evacuation strategies tested for the Y-shaped graph : simultaneous or delayed evacuation}
