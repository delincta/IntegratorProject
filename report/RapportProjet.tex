...
\end{figure}
When the two tanks are being emptied at the same time (figure~\ref{fig:simpleNetwork_resultBothTanksEmpt}), there is some stress on cell X4 (it peaks at 85 vehicles around 400s). This can be explained by the addition of vehicles coming from the first and second tanks, which accumulate at cell 4. 
