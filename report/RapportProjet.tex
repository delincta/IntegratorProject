...
For this part, we observe that the results are slightly worse than for the line graph. Indeed, larger discrepancies can be observed between the MPC results and those of the simulator. However, the general trends are still respected, which indicates that the MPC is able to capture the main dynamics of the system despite the observed deviations.
