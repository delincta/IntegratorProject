...
\[
    with\,\beta=min(\frac{s_j(x_j(k))}{\sum_{i=1}^{m}{d_i(x_i(k))}},1)
\]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/graph_2Tanks_6cells.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/tank_states_simulateur_OL.png}
    \includegraphics[width=0.7\textwidth]{figures/tank_states_simulateur_OL_command_differe.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/cell_states_simulateur_OL.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/cell_states_simulateur_OL_command_differe.png}
...
The MPC gave us acceptable results, which we interpret as follows : 
...
\subsubsection{Junction with two single cells}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/Mpc_tank_states_hor200_2000iter.png}
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/Simulator_tank_states_hor200_2000iter.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/Mpc_cells_states_hor200_2000iter.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figures/Simulator_cells_states_hor200_2000iter.png}
...
\subsubsection{Junction with many cells to a single one}
