...
The discrete-time dynamics of the network describe the evolution of vehicle number of vehicles in tanks and transport cells. Tank number of vehicles decrease according to the outgoing flows to the cells, while cell number of vehicles increase with incoming flows and decrease with outgoing flows and network outflows. This formulation directly links the flows to the network states.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/line_graph/graph_2Tanks_6cells.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/line_graph/Open_loop/tank_states_simulateur_OL.png}
    \includegraphics[width=0.7\textwidth]{figures/line_graph/Open_loop/tank_states_simulateur_OL_command_differe.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/line_graph/Open_loop/cell_states_simulateur_OL.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/line_graph/Open_loop/cell_states_simulateur_OL_command_differe.png}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/line_graph/Simulator_Mpc_coupled/Mpc_tank_states_hor200_2000iter.png}
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/line_graph/Simulator_Mpc_coupled/Simulator_tank_states_hor200_2000iter.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/merge_graph/Simulator_Mpc_coupled/Mpc_cells_states_hor200_2000iter.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figures/merge_graph/Simulator_Mpc_coupled/Simulator_cells_states_hor200_2000iter.png}
